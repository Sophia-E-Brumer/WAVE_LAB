...
function [lat,lon,freq,dir,df,time,spectra1,depth,U10,curr,currdir,unit1]=readWWNC_SPEC(filename,varname,date1)
%
...
%
    ...
    varc1 = netcdf.inqVarID(fid,'wnd');
    U10=  netcdf.getVar(fid,varc1,[LL-1 KK-1],[nl nk]);
 netcdf.close(fid);    
